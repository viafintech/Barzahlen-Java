...
/**
 * Handles transaction paid request
 */
abstract public class TransactionPaidNotificationHandler extends TransactionNotificationHandler {

    public TransactionPaidNotificationHandler(final Configuration configuration) {
        super(configuration);
    }

    /**
     * Will be called on Transaction paid event
     *
     * @param transactionId
     * @param shopId
     * @param customerEmail
     ...
     * @param customVar2
     */
    abstract protected void onTransactionPaid(final String transactionId, final String shopId,
    ...
    public void handleRequest(final HttpRequest httpRequest, final HttpResponse httpResponse) {
        ...
        onTransactionPaid(parameters.get("transaction_id"), parameters.get("shop_id"),

...
/**
 * Handles refund expired request
 */
abstract public class RefundExpiredNotificationHandler extends RefundNotificationHandler {

    public RefundExpiredNotificationHandler(final Configuration configuration) {
        super(configuration);
    }

    /**
     * Will be called on Refund expired event
     *
     ...
     * @param customVar2
     */
    abstract protected void onRefundExpired(final String refundTransactionId, final String originTransactionId,
    ...
    public void handleRequest(final HttpRequest httpRequest, final HttpResponse httpResponse) {
        ...
        onRefundExpired(parameters.get("refund_transaction_id"), parameters.get("origin_transaction_id"),
